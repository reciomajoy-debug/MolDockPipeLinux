...
def _handle_sigint(sig, frame):
    ...
    if not STOP_REQUESTED:
        STOP_REQUESTED = True
        print("\nCtrl+C detected — will stop submitting new jobs, finish in-flight, then exit cleanly.")
        print("   (Press Ctrl+C again to stop ASAP after current checkpoint.)")
    else:
        HARD_STOP = True
        print("\nSecond Ctrl+C — will attempt to cancel pending work and finalize outputs.")
